...
const LoginForm = ({ isExpanding, onBackClick }) => {
  ...
  return (
    ...
    <div className="flex flex-col items-center mb-8">
        ...
        <div className="flex items-start sm:items-center gap-1 sm:gap-1 mb-4">
        <button
            type="button"
            onClick={onBackClick}
        ...
        <h2 className="text-xl sm:text-2xl font-bold text-primary dark:text-blue-400 text-center leading-tight mr-2">
